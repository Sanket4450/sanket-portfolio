              ...
              <article className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 lg:gap-16">
                ...
                <div>
                  <div className="mb-6">
                    ...
                    <h3 className="text-[28px] sm:text-[32px] leading-[1.15] font-bold tracking-[-0.02em] text-foreground">
                      {system.title}
                    </h3>
                  </div>
                    ...
                    <ul className="space-y-3">
                      {system.achievements.map((a) => (
                        <li
                          ...
                          <ArrowRight className="w-4 h-4 text-text-muted mt-0.5 shrink-0" />
                          <span>{a}</span>
                        </li>
                      ))}
                    </ul>
