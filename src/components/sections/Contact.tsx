...
export default function Contact() {
  return (
    <section id="contact" className="section-padding border-border border-t">
      <div className="section-container text-center">
        ...
        <Reveal delay={100}>
          <p className="text-text-secondary mx-auto mb-6 max-w-[620px] text-lg leading-[1.7]">
            {contactSection.description}
          </p>
        </Reveal>

        <Reveal delay={150}>
          <p className="text-text-muted mb-12 flex flex-wrap items-center justify-center gap-y-1 text-sm">
